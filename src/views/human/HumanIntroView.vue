...
export default {
  ...
  data() {
    return {
      ...
      choices2: [
        { outcomes: [
          `Aujourd'hui, je me prépare pour un rendez-vous avec mon patron. Je compte bien lui dire ce que je pense à propos des conditions de travail depuis que la concurrence nous oppresse. Je suis prêt à défendre les droits des travailleurs humains face à cette automatisation menaçante. Je me prépare à partir, en étant déterminé à montrer que je vais pas me laisser faire`,
