<template>
    <div>
      <div class="bg-human--bg-appart bg-cover bg-bottom bg-black text-white font-rationale text-base px-56 h-screen flex flex-col gap-8 pt-6 overflow-scroll">
        <CardText :text="outcomeText1" />
        
        <CardText :text="outcomeText2"/>
        
        <ul v-if="!showContent1 && !showContent2 && !showContent3" class="font-black-ops-one text-xl flex justify-around mt-6">
        ...
        <div v-if="showContent1">
            ...
            <NextButton class="flex justify-center mt-8" link="humanBar" text="En route pour le bar" />
        </div>
        ...
        <div v-if="showContent2" class="flex flex-col gap-8">
            ...
            <NextButton class="mb-16" link="humanSleep" text="Aller dormir" />
        </div>
